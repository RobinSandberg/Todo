...
public class App
{
    public static void main( String[] args )
    {
        ...
        System.out.println(people.addPerson(new Person("Robin","Sandberg")));
        ...
        System.out.println(todoItems.create(new Todo("Doom", "Finish the game Doom eternal.", Date.valueOf("2020-06-25"), false)) != null);
        System.out.println(todoItems.create( new Todo("Warframe", "Farm for Titania prime.", Date.valueOf("2020-05-20"), false ,1)) != null);
        System.out.println(todoItems.create(new Todo("Dinner", "Pick up pizza.", Date.valueOf("2020-05-28"), true)) != null);
        List<Todo> foundTodoList;
        Person person = people.findById(1);
        foundTodoList = todoItems.findByAssignee(person);
        foundTodoList.forEach(System.out::println);
        Todo foundTodo = todoItems.findById(41);
